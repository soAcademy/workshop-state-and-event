...
// เอาข้อมูล Hard code มาทำเป็นตัวแปร
...
const DeathCause3 = () => {
  ...
  const totalDeath = 408000;
  const deathByCauses = [
    { cause: "วัณโรคทุกชนิด", death: 189000 },
    { cause: "เบาหวาน", death: 130000 },
  ];

  const deathByProvinces = [
    { province: "กรุงเทพมหานคร", death: 189000, },
    { province: "เชียงใหม่", death: 109000, },
  ];
