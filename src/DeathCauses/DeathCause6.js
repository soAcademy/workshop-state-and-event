...
// อันนี้เราจะทำเหมือนเดิมเพิ่มเติมคือทำให้ข้อมูลเปลี่ยนแปลงไปตามปีได้
...
// อันไหนที่มันเปลี่ยนแปลงได้ เราจะเอามาเปลี่ยนเป็นตัวแปรให้หมด
// มีการใช้ State แล้วก็เอา useEffect มาครอบอีกที
// อะไรที่เป็ฯตัวแปร State เราจะตั้ชื่อให้มันเป็น Temp โดยการเอาunderscore เข้ามา แล้วก็มาตั้งชื่อใหม่อีกที
