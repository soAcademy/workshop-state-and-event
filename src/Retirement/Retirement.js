...
const Retirement = () => {
  ...
  }, [currentAge, planAge, retireAge, monthlyExpense, inflation,investmentPerYear,percentReward]);
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-1/2 mx-auto">
          <table className="border-collapse border border-slate-400">
            <tr>
              <th className="border border-slate-300 p-4 text-center w-1/3">Age</th>
              <th className="border border-slate-300 p-4 text-center w-1/3">
                Annually Expense
              </th>
              <th className="border border-slate-300 p-4 text-center w-1/3">Investment</th>
            </tr>
