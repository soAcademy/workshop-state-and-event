...
const Trivia2 = () => {
  ...
  return (
    <>
      ...
      <>
      <div className="text-center bolt text-3xl">
      ...
      <div className="grid gap-2 grid-cols-2 ">
        {quizes[currentQuiz].answers.map((r, index) => (
          <button
            className="bg-sky-400 py-2 rounded-lg"
    ...
    {currentQuiz >= quizes.length && <div className="both text-center text-xl bg-purple-400" >สรุปคะแนน {score}</div>}
    </>
  );
};
