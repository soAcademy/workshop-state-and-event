...
const CurrencyConverter6 = () => {
  ...
  console.log("toCurrencyRate",toCurrencyRate)
  const authToken =
  ...
  useEffect(() => {
    ...
    axios({
      ...
      setChartOption(_chartOption);
        ...
        console.log("ToCurrencyRate",_toCurrencyRate)
  ...
  return (
    <div>
      <div className="bg-red-300 w-1/2 m-auto mt-12 rounded-lg">
        <h1 className="text-center p-2 text-2xl font-bold bg-sky-300 rounded-lg">Currency Converter</h1>
