...
const ZipCodeProvince = () => {
  return (
    <div>
      ...
      <div className="w-4/5 mx-auto px-4 mt-10 bg-gray-100 rounded">
        <table className="w-full">
          <thead>
            <tr className="text-center font-semibold">
              <th className="p-1">#</th>
              <th className="p-1">อำเภอ/เขต</th>
              <th className="p-1">รหัสไปรษณีย์</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="text-center p-1">1</td>
              <td className="text-center p-1">เขตคลองสาน</td>
              <td className="text-center p-1">10600</td>
            </tr>
          </tbody>
        </table>
      </div>
