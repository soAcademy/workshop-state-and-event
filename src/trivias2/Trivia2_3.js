...
const Trivia2_3 = () => {
  ...
  const checkAnswer = (answerId) => {
    const newScore = quizzes[currentQuestion].answer === answerId ? (score + 1) : 0
    setScore(newScore)
  ...
  return (
    <div className="text-center pt-2">
      <div>Question: {[currentQuestion + 1]}/{quizzes.length} </div>   {/* will be displayed in decomals if writtten like this ://{[currentQuestion + 1]/quizzes.length} */}
